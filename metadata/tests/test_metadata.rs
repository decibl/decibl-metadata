use decibl_metadata::engine::{config::get_soundfiles_path_1, audio_metadata::{file_to_hash, string_to_hash, get_symphonia_data, add_symphonia_data}};
#[cfg(test)]
...
fn test_file_to_hash(){
    ...
    assert_eq!(hash, "2916D1AF7C16DF259A98FEC02A984F10CD0AF370A339CE6C40670F14FB364E6E");
}
...
fn test_symphonia_data(){
    ...
    assert_eq!(data.get("TITLE").unwrap(), &vec!["brakence 2.0 freestyle (feat. Majent)"]);
